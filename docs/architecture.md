...
`@kupola/pivot-ui` can render timelines, timeline detail views, audit viewers, plan previews, plan graphs, and results as escaped HTML strings or mount them into DOM elements. The renderer is intentionally small and framework-neutral.
