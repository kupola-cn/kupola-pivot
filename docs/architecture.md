...
`@kupola/pivot-ui` can render timelines, timeline detail views, and results as escaped HTML strings or mount them into DOM elements. The renderer is intentionally small and framework-neutral.
